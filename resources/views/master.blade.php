    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="simple"><i class="fa fa-circle-o"></i> Simple tables</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="404"><i class="fa fa-circle-o"></i> 404 Error</a></li>
            <li><a href="500"><i class="fa fa-circle-o"></i> 500 Error</a></li>
            <li><a href="blank"><i class="fa fa-circle-o"></i> Blank Page</a></li>
            <li><a href="pace"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li><a href="index"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
